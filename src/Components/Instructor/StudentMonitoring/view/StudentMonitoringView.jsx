        ...
        {students.map((student, index) => {
            ...
            >
                ...
                <div style={{ marginTop: '16px', borderTop: '1px solid #e0e0e0', paddingTop: '16px' }}>
                    <div style={{ fontWeight: 'bold', fontSize: '14px', marginBottom: '8px' }}>Performance Overview
                    <span>
                        <button onClick={handleFetchStudentLogbooks} style={{fontSize: '13px',marginLeft: 15, backgroundColor: '#ff9e9e', borderRadius: 5, paddingTop: 1, paddingBottom: 1, paddingLeft: 10, paddingRight: 10}}>
