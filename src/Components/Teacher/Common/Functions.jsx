...
export const fetchStudentsByInstructor = async (setStudents, setIsSubmitting, setIsSuccess, setErrorMessage, setIsError, instructorId) => {
...
export const fetchAllStudentsFilterDepartment = async (setAllStudents, setErrorMessage, setIsError, departmentCode) => {
  try {
