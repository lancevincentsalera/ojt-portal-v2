...
const InternListController = () => {
  ...
  return (
    <>
      <InternListView internList={internList} tableHeaders={tableHeaders} handleModalAction={handleModalAction} showModal={showModal} handleFormChange={handleFormChange} handleRegister={handleRegister} />
